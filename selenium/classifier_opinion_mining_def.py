...
def lreg(rev_train,labels_train,rev_test,labels_test):
    ...
    pickle.dump(gridsearch_nb_best, open('finalized_model_lreg.sav', 'wb'))
...
def nb(rev_train,labels_train,rev_test,labels_test):
    ...
    pickle.dump(gridsearch_nb_best, open('finalized_model_nb.sav', 'wb'))
...
if __name__ == "__main__": 
    ...
    rev_train,labels_train,rev_test,labels_test=balance_labels('opinion_mining_labels.txt')
    ...
    loaded_model_lreg = pickle.load(open('finalized_model_lreg.sav', 'rb'))
    ...
    print(loaded_model_lreg.predict(rev_train))
